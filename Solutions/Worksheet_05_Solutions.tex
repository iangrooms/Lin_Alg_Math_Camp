...
\[\mathbf{A} + t\mathbf{B} = \mathbf{S}\left(\mathbf{I} + t\mathbf{D}\right)\mathbf{S}^T\]
where $\mathbf{D}$ is diagonal, for every $t$ (i.e.\ none of the matrices in the above expression depends on $t$).
...
\[\mathbf{A} + t\mathbf{B} = \mathbf{L}\left(\mathbf{I} + t\mathbf{L}^{-1}\mathbf{BL}^{-T}\right)\mathbf{L}^T.\]
...
\[\mathbf{L}\left(\mathbf{I} +t\mathbf{QDQ}^T\right)\mathbf{L}^T = \mathbf{L}\left(\mathbf{QQ}^T +t\mathbf{QDQ}^T\right)\mathbf{L}^T=\mathbf{LQ}\left(\mathbf{I} +t\mathbf{D}\right)(\mathbf{LQ})^T.\]
